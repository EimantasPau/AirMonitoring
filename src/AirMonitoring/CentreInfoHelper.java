...
/**
* AirMonitoring/CentreInfoHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from AirMonitoring.idl
* Tuesday, 10 April 2018 13:29:09 o'clock BST
*/

abstract public class CentreInfoHelper
{
  private static String  _id = "IDL:AirMonitoring/CentreInfo:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[2] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (AirMonitoring.CentreInfoHelper.id (), "CentreInfo", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    AirMonitoring.CentreInfo value = new AirMonitoring.CentreInfo ();
